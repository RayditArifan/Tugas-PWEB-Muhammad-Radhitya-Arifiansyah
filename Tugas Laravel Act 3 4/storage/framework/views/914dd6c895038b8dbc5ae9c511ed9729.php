<?php $__env->startSection('title', 'Dashboard — Inventaris RobuxRadit'); ?>
...
<section class="hero">
  <div>
    ...
    <h2>Selamat datang, <?php echo e($username); ?>! 👋</h2>
    <p>
...
<section id="dashboard" class="dashboard-section">
  ...
  <div class="card-grid">
    ...
    <article class="card stat-card">
      ...
      <h3>Rp <?php echo e(number_format($totalNilai, 0, ',', '.')); ?></h3>
...
<section class="quick-action-section">
  ...
  <div class="quick-grid">
    <a href="<?php echo e(route('pengelolaan', ['username' => $username])); ?>" class="quick-card">
      <span class="quick-icon">📦</span>
      <h3>Kelola Inventaris</h3>
      <p>Lihat dan kelola seluruh daftar barang.</p>
    </a>
    <a href="<?php echo e(route('profile', ['username' => $username])); ?>" class="quick-card">
      <span class="quick-icon">👤</span>
      <h3>Profil Saya</h3>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Robuxraditt\resources\views/dashboard.blade.php ENDPATH**/ ?>