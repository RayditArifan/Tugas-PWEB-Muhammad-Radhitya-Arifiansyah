...
unset($__errorArgs, $__bag); ?>
  ...
  <div class="form-group">
    ...
    <input type="date" id="tanggal_masuk" name="tanggal_masuk" value="<?php echo e(old('tanggal_masuk', isset($barang) && $barang->tanggal_masuk ? $barang->tanggal_masuk->format('Y-m-d') : date('Y-m-d'))); ?>">
...
unset($__errorArgs, $__bag); ?>
    ...
    <?php if(isset($barang)): ?>
      <?php if($barang->foto): ?>
        <small>Foto saat ini: <?php echo e($barang->foto); ?></small>
      <?php endif; ?>
    <?php endif; ?>
  </div>
</div>
...
<div class="button-row">
  ...
  <a href="<?php echo e(route('pengelolaan')); ?>" class="btn btn-secondary">Batal</a>
</div>
