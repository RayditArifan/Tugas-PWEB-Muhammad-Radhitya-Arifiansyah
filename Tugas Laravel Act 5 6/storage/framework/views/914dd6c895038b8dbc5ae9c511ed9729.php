...
<section class="hero">
  <div>
    ...
    <h2>Selamat datang, <?php echo e(auth()->user()->name ?? $username); ?>! 👋</h2>
    <p>
...
<section class="quick-action-section">
  ...
  <div class="quick-grid">
    <a href="<?php echo e(route('pengelolaan')); ?>" class="quick-card">
      <span class="quick-icon">📦</span>
      <h3>Kelola Inventaris</h3>
      <p>Lihat dan kelola seluruh daftar barang.</p>
    </a>

    <a href="<?php echo e(route('profile')); ?>" class="quick-card">
      <span class="quick-icon">👤</span>
      <h3>Profil Saya</h3>
